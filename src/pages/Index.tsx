  ...
  return (
    <div className="min-h-screen bg-background font-sans text-foreground selection:bg-primary/30 selection:text-primary-foreground overflow-x-hidden">
      ...
      <section className="relative min-h-[100dvh] flex items-center justify-center bg-background overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 flex flex-col items-center justify-center h-full pt-28 md:pt-36">
          <div className="flex flex-col items-center text-center max-w-5xl mx-auto">

            <AnimatePresence>
              {isCardVisible && (
                <motion.div layout exit={{ opacity: 0, scale: 0.9, height: 0, marginBottom: 0 }}>
                  <CredibilityCard onClose={() => setIsCardVisible(false)} />
                </motion.div>
              )}
            </AnimatePresence>
      ...
      {/* ECOSYSTEM SECTION */}
      <section className="py-16 md:py-32 container mx-auto px-4 bg-background">
      ...
      {/* WHY CHOOSE US */}
      <section className="py-16 md:py-32 bg-secondary border-t border-white/[0.08] overflow-hidden">
      ...
      <section className="py-16 md:py-32 bg-background relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <h2 className="text-4xl md:text-7xl font-bold text-foreground mb-8 tracking-tighter">Ready to Scale?</h2>
